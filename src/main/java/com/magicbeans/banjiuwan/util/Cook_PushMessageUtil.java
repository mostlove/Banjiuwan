...
public class Cook_PushMessageUtil {

	private static Logger logger = Logger.getLogger(Cook_PushMessageUtil.class);
	 ...
	 * @param extend
	 */
	public static void pushMessages(Cook user, String content, Map<String, String> extend){
