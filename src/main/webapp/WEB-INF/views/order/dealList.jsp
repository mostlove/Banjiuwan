                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 padding-left-5">
                                                        <label class="form-control" >已成交</label>
                                                        <input type="hidden" id="status" name="status" value="2002,2003,2004,2005,2006,2007,2008" />
