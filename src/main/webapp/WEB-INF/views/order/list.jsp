...
<body>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 padding-left-5">
                                                        <select multiple="multiple" id="payMethod" name="payMethod">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 padding-left-5">
                                                        <select multiple="multiple" id="status" name="status">
                                                            ...
                                                            <option value="2009">退款中</option>
                                                            <option value="2010">退款成功</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <input class="btn btn-blue" type="hidden" value="上传头像" id="addAvatar">
...
//        }
        ...
        $(function(){
            ...
            var totalpage = initData(1,15,null,null,null,null,null,null,1);
