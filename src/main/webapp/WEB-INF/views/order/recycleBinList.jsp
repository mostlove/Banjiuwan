...
//        }
        ...
        $(function(){
            ...
            var totalpage = initData(1,15,null,null,null,null,0);
            ...
            $.jqPaginator('#pagination', {
                ...
                onPageChange: function (num, type) {
                    ...
                    if(type != "init"){
                        ...
                        //获取第num页数据，
                        initData(num,15,status,orderNumber,userPhone,payMethod,0);
                    }
                }
            });
        ...
        function sub(){
            ...
            var payMethod = $("#payMethod").val();
            //获取第num页数据，
            initData(1,15,status,orderNumber,userPhone,payMethod,0);
        }
    </script>
