...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="<%=request.getContextPath()%>/web/homeBanner/add" class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>新增Banner</a>
                            </div>
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/homeBanner/list.js"></script>
    <script>
