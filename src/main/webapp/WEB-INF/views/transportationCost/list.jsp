...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="javascript:void(0)" onclick="addConfig()" class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>新增配置</a>
                            </div>
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/transportationCost/list.js"></script>
    <script>
