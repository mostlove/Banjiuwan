...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="javascript:void(0);" onclick="addWeddingSon()" class="btn btn-palegreen float-right"><i class="fa fa-plus"></i>添加配置</a>
                            </div>
                            <div class="portlet-body">
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/wedding/son/list.js"></script>
    <script>
