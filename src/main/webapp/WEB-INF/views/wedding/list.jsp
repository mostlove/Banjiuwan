...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="<%=request.getContextPath()%>/web/wedding/addPage" class="btn btn-success float-right"><i class="fa fa-plus"></i>新增婚庆预约</a>
                                <a href="<%=request.getContextPath()%>/web/wedding/son/list" class="btn btn-palegreen float-right"><i class="fa fa-plus"></i>配置管理</a>
                                <a href="<%=request.getContextPath()%>/web/wedding/category/list" class="btn btn-palegreen float-right"><i class="fa fa-plus"></i>区域管理</a>
                            </div>
                            <div class="portlet-body">
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/wedding/list.js"></script>
    <script>
