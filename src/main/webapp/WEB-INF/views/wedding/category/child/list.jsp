...
<body>
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            <li>
                <a target="iframe" href="<%=request.getContextPath()%>/web/wedding/category/list" >返回上一级</a>
            </li>
            <li class="active">婚庆预约-区域配置管理</li>
        </ul>
    </div>
    <!-- /Page Breadcrumb -->
    <div class="page-body">
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="<%=request.getContextPath()%>/web/wedding/category/child/addPage?weddingCategoryId=${weddingCategoryId}&categoryName=${categoryName}"  class="btn btn-palegreen float-right"><i class="fa fa-plus"></i>添加区域配置</a>
                            </div>
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/wedding/category/child/list.js"></script>
    <script>
        ...
        $(function(){
            ...
            var categoryId = "${weddingCategoryId}";
            setValue(categoryName);
            var totalpage = initData(1,15,null,categoryId);
            addpage(); //加载分页方法
            ...
            $.jqPaginator('#pagination', {
                ...
                onPageChange: function (num, type) {
                    ...
                    if(type != "init"){
                        //获取第num页数据，
                        initData(num,15,null,categoryId);
                    }
                }
            });
