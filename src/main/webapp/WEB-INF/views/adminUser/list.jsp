...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="<%=request.getContextPath()%>/web/adminUser/addPage" class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>新增后台管理</a>
                            </div>
                            <div class="portlet-body">
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/adminUser/list.js"></script>
    <script>
