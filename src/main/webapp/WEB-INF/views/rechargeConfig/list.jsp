...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="javascript:void(0)" onclick="addRechargeConfig()"  class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>新增充值配置</a>
                            </div>
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/rechargeConfig/list.js"></script>
    <script>
