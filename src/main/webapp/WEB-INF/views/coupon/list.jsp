...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="<%=request.getContextPath()%>/web/coupon/AddPage"  class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>新增优惠券</a>
                                <a href="<%=request.getContextPath()%>/web/coupon/detail"  class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>查看优惠券使用情况</a>
                            </div>
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/coupon/list.js"></script>
    <script>
        ...
        $(function(){
            ...
            var totalpage = initData(null,1,15);
