...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="<%=request.getContextPath()%>/web/vegetables/dish/list" class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>管理菜品</a>
                                <a href="javascript:void(0)" onclick="addVegetablesPrice()" class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>添加实时菜价</a>
                            </div>
                            <div class="portlet-body">
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/vegetables/list.js"></script>
    <script>
        ...
        $(function(){
            ...
            $.jqPaginator('#pagination', {
                ...
                onPageChange: function (num, type) {
                    ...
                    if(type != "init"){
                        //获取第num页数据，
                        initData(num,totalpage,null,null);
                    }
                }
            });
