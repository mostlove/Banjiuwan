...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="javascript:void(0)" onclick="addVegetablesHouse()" class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>添加菜品</a>
                            </div>
                            <div class="portlet-body">
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/vegetables/dish/list.js"></script>
    <script>
