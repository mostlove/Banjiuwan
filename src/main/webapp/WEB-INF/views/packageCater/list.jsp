...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="<%=request.getContextPath()%>/web/package/addPage" class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>新增套餐/坝坝宴</a>
                            </div>
                            <div class="portlet-body">
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/package/list.js"></script>
    <script>
