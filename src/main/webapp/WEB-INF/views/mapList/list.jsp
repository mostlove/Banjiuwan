...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="well with-header">
                            <div class="header bordered-darkpink">
                                ...
                                <a href="<%=request.getContextPath()%>/web/mapList/addPage" class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>新增围栏</a>
                                <a href="javascript:void(0)" onclick="setInside()" class="btn btn-success float-right btn-sm"><i class="fa fa-plus"></i>设置圈内可点菜品</a>
                            </div>
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/mapList/list.js"></script>
    <script>
