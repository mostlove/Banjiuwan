...
<body>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group margin-bottom-20">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 padding-right-5">订单号</label>
                                                    <div class="col-md-8 padding-left-5">
    ...
    <!-- 私有js -->
    <script src="<%=request.getContextPath()%>/resources/js/evaluate/evaluateOrderList.js"></script>
    <script>
            ...
            $.jqPaginator('#pagination', {
                ...
                onPageChange: function (num, type) {
                    ...
                    if(type != "init"){
                        ...
                        //获取第num页数据，
                        initData(num,15,userType,evaluateLevel,isPass,orderNumber);
                    }
                }
            });
        ...
        function sub(){
            ...
            //获取第num页数据，
            initData(1,15,userType,evaluateLevel,isPass,orderNumber);
        }
