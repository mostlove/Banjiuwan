...
<script>
    ...
    geolocation.getCurrentPosition(function(r) {
        if(this.getStatus() == BMAP_STATUS_SUCCESS) {
            ...
            //自定义标注
            var markerIcon = new BMap.Icon( BJW.ip + "/appResources/img/icon/address-icon1.png",new BMap.Size(40,40));
            var marker = new BMap.Marker(point2,{icon : markerIcon});  // 创建标注
            ...
            map.addEventListener("dragend", function() {
                ...
                var markerIcon2 = new BMap.Icon( BJW.ip + "/appResources/img/icon/address-icon1.png",new BMap.Size(0,0));
                var marker1 = new BMap.Marker(centerPoint,{icon : markerIcon2});// 创建标注
