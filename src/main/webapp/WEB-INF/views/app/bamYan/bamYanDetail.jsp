...
<body>
    ...
    <div id="pullrefresh" class="mui-content">
            ...
            <div class="commodity-detail">
                ...
                <p class="commodity-row">
                    <span class="commodity-price">
                        <span class="price" id="priceHtml">0</span>
                        <span id="danWei2">/份</span>
                        <span class="fiveRise"><span id="fiveRise">0</span>桌起订</span>
                    </span>
                    <div class="addBtnBox">
            ...
            <div class="evaluate">
                ...
                <div class="commodity-introduce call-bar">
                    <p>亲，你好!</p>
                    <p>很高兴为您服务，按键召唤，3分钟我会拨打您的电话。</p>
                    <div class="mui-input-row">
                        <input type="text" class="mui-input-clear" placeholder="请在此输入您的号码" maxlength="11" id="phone">
                    </div>
    ...
    <script type="text/javascript">
        ...
        function pullupRefresh() {
            $(".mui-pull").show();
            var html = getEvaluateList(4, foodId, ++pageNo1, 10);
            setTimeout(function() {
                if (html == "") {
        ...
        function addCart(event, obj) {
            addOrReduceShopCar(event, obj, 1, foodId, $("#foodCategoryId").val(), null, null, null, $("#price").val(), BJW.ip + "/app/page/bamYanDetail?isOpen=4&foodId=" + foodId);
        }

        //购物车减
        function reduceCar(obj){
            addOrReduceShopCar(null, obj, 0, foodId, $("#foodCategoryId").val(), null, null, null, $("#price").val(), BJW.ip + "/app/page/bamYanDetail?isOpen=4&foodId=" + foodId);
        }
